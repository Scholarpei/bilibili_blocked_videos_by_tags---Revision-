...
`;
  ...
  function addButtonToCard(card) {
    ...
    const btnHTML = `<button type="button" class="gm-copy-tags-btn"
        style="position: absolute; bottom: 6px; right: 6px; z-index: 10; padding: 4px 6px; font-size: 12px; background: #0094CA; color: #fff; border: none; border-radius: 6px; cursor: pointer; box-shadow: 0 2px 6px rgba(0,0,0,0.2);">
        📋
    </button>`;
...
function injectButtonIfNeeded(card) {
  ...
  try {
    ...
    btn.textContent = "📋";
    btn.title = "复制/屏蔽（脚本）";
    btn.style.cssText = "position:absolute;right:6px;bottom:6px;z-index:20;padding:4px 6px;border-radius:6px;border:0;background:#0094CA;color:#fff;cursor:pointer;";
